...
def getStockInfo(lst, stockURL, fpath):
    ...
    for stock in lst:
        url = stockURL + stock + "/jibenziliao/"  # url为单只股票的url
...
def get_txt():  # 将爬取的数据保存在TXT文件中
    ...
    output_file = 'output\\GuChengStockInfoTest.txt'
    slist = []
...
def main():
    ...
    get_txt()
    txt = "output\\GuChengStockInfoTest.txt"
    excelname = 'output\\GuChengStockInfoTest.xls'
